...
wget -nc http://mirrors.slackware.com/slackware/slackware64-14.2/slackware64/FILE_LIST -O $D/FILE_LIST_14.2

slack_package_14.2_urlbase="http://mirrors.slackware.com/slackware/slackware64-14.2/slackware64"

for i in "${slack_package_14.2[@]}"
do
package_locations=$(grep "\<$i-[[:digit:]].*.txz$" FILE_LIST_14.2 | cut -b 53-9001)
echo "$slack_package_14.2_urlbase""$package_locations" >> "$D"/14.2URLS
done
